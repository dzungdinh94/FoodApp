    ...
    <Screen style={ROOT} preset="scroll">
      ...
      <View style={styles.container}>
        <View style={{ alignItems: 'center', }}>
          ...
          <Text style={{ fontSize: 24, lineHeight: 28, fontFamily: 'SegoeUI', fontWeight: 'bold', color: 'black', paddingTop: 40, }} text="Chờ nhận hàng" />
          <Text style={{ fontSize: 17, lineHeight: 22, fontFamily: 'SegoeUI', fontWeight: 'normal', color: 'rgb(102,102,102)', paddingTop: 8, paddingHorizontal: 59, textAlign: 'center' }} text="Hàng của bạn đã được chuẩn bị xong và chờ bạn tới nhận" />
